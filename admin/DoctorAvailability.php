<!DOCTYPE html>
	<html>
		...
		<body>
				...
				<div class="top-nav">
					<ul>
						<li class="active"><a href="DoctorAvailability.php">Doctor Availability</a></li>
						
						<li><a href="bbDonorForm.php">Blood Bank Donor Form</a></li>
			  ...
			  <div>
				  <form method="POST" action ="scheduleUpload.php" autocomplete="off">
